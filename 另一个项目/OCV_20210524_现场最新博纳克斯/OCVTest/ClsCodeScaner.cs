    ...
    public class ClsCodeScaner
    {
        ...
        public bool SetPortProperty(string port, int BaudRate, string parity, int dataBits, float stopBits)
        {
            ...
            if ((mSerialPort != null) && (mSerialPort.IsOpen == false))
            {
                ...
                if ((s.CompareTo("无校验") == 0) || (s.CompareTo("无") == 0) || (s.CompareTo("None") == 0) || (s.CompareTo("None") == 0))
                {
                ...
                {
                    throw new Exception("扫码器COM口错误" + ex.Message);
                    //return false;
                }
            }
            else
