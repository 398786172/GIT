...
namespace OCV
{
    public partial class FrmSys : CCSkinMain //Form
    {
        ...
        private void FrmSys_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        ClsGlobal.CodeScan = new ClsCodeScan();
        ...
        private void tim_UI_Tick(object sender, EventArgs e)
        {
            ...
            SetPLCError1(ClsPLCValue.PlcValue.Plc_Error1, ClsPLCValue.PlcValue.Plc_Error2);
        }
        ...
        private void FrmSys_FormClosed(object sender, FormClosedEventArgs e)
        {
            try
            {
                if (ClsGlobal.CodeScan != null&&ClsGlobal.CodeScanMode==1)
                {
        ...
        private void 密码修改ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string strConnect = string.Format(info, ClsGlobal.Server_OCV_IP, ClsGlobal.Server_OCV_DB, ClsGlobal.Server_OCV_id, ClsGlobal.Server_OCV_Pwd); //ClsGlobal.Server_OCV_DB,ClsGlobal.Server_OCV_id,ClsGlobal.Server_OCV_Pwd
        ...
        public void InitPlc()
        {
            ...
            ShowInfo("开始初始化设备..." + Environment.NewLine);
            ...
            Action act = delegate
            {
                ...
                do
                {
                    ...
                    if (ClsPLCValue.PlcValue.Plc_InitReply == 1) //   ClsPLCValue.PlcValue
                    {
                        ...
                        ShowInfo("初始化完成" + Environment.NewLine);
                        break;
                    }
                    Thread.Sleep(100);
                } while (dSeconds < 30);
