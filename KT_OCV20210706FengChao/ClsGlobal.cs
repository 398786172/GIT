...
namespace OCV
{
    ...
    public class ClsGlobal
    {
        ...
        public static dynamic CodeScan;
        //public static ClsCodeScan CodeScan = new ClsCodeScan();  //扫码器
        public static int CodeScanMode;//扫码枪通讯模式
        public static string CodeScanIP;//扫码枪IP
        public static string CodeScanPort;//扫码枪Port
        ...
        public static int UIsettingTestType;  //UI选择手动测试参数
        ...
        public static int SetPos10;
        public static int SetPos11;
        public static int SetPos12;
        public static int SetPos13;
        ...
        public ClsGlobal()
        {
            ...
            SetPos10 = StringToInt(Helper.SelectXmlNode(xmlPath, "root", "Pos10Value"), 80);
            SetPos11 = StringToInt(Helper.SelectXmlNode(xmlPath, "root", "Pos11Value"), 80);
            SetPos12 = StringToInt(Helper.SelectXmlNode(xmlPath, "root", "Pos12Value"), 80);
            SetPos13 = StringToInt(Helper.SelectXmlNode(xmlPath, "root", "Pos13Value"), 80);
