...
namespace OCV
{
    public class ClsPLCModel
    {
        ...
        public short Plc_ResetFinished { set; get; }    //PLC表示复位
        ...
        public short Plc_On_Position { get; set; } //PLC_到位
        public short Plc_CurrentPosition1 { get; set; } //PLC当前位置1
        public short Plc_CurrentPosition2 { get; set; } //PLC当前位置2
        public short Plc_CurrentPosition3 { get; set; } //PLC当前位置3
        public short Plc_CurrentPosition4 { get; set; } //PLC当前位置4
        /// <summary>
        /// 生产周期
        /// </summary>
        public short Plc_Period1 { get; set; }
        public short Plc_Period2 { get; set; }
        public short Plc_Alarm1 { set; get; }    //报警汇总1
        public short Plc_Alarm2 { set; get; }    //报警汇总2
        public short Plc_Error1 { set; get; }     //报警汇总1
        ...
        public short Plc_IO_TrayOutputSignal { set; get; }          //托盘出料检测
        ...
        public short Plc_IO_M1 { set; get; }    //M1
        public short Plc_IO_M2 { set; get; }     //M2
