...
namespace OCV
{
    ...
    public class ClsSWControl
    {
        ...
        /// <summary>
        /// 函数: 切换控制命令, 测试类型1:电压+内阻
        /// </summary>
        /// <param name="SWType">切换类型:  单->1  双->2</param>  1  
        /// <param name="TestType">    
        /// 测试类型: 
        ...
        /// <summary>
        /// 函数: 切换控制命令,测试类型2: 正负极电压+负极对壳压 
        /// </summary>
        /// <param name="SWType">切换类型:正负极->1， 壳体->2</param> 
    ...
    public class ClsIODef
    {
        ...
        //public const ushort Addr_HOST_ReqClearAlarm = 37;        //报警复位请求
        //public const ushort Addr_HOST_ReqReset = 38;             //设备复位

        //public const ushort Addr_HOST_ReqPressPB = 40;           //针床压合请求
        ...
        //public const ushort Addr_HOST_Debug = 45;                //调试状态
