...
namespace DB_OCV.DAL
{
    ...
    public class DBCOM_OCV
    {
        ...
        public DBCOM_OCV(string iP, string database, string userID, string pWD)
        {
            ...
            batData = new BatData(StrB.ToString());
        }
                    ...
                    switch (OCVTable)
                    {
                        case 0:     //OCV1
                            if (!theList[i].Cell_ID.Contains("NullCellCode"))
                            {
                                ...
                                BatInfo.Eqp_ID = ClsGlobal.RESRCE;
                                ...
                                BatInfo.OCV_VOLTAGE = theList[i].OCV_Now;
                                ...
                                //BatInfo.SHELL_VOLTAGE = theList[i].OCV_Shell_Now;
                                ...
                                //BatInfo.V_DROP_RESULT = theList[i].ACIR_NgResult.NgCode;
                                //BatInfo.V_DROP_RESULT_DESC = theList[i].ACIR_NgResult.NgCode;
                                //BatInfo.ACIR_RANGE = theList[i].ACIR_range;
                                //BatInfo.R_RANGE_NG_CODE = theList[i].ACIR_NgResult.NgCode;
                                //BatInfo.R_RANGE_RESULT = theList[i].ACIR_NgResult.NgCode;
                                //BatInfo.R_RANGE_RESULT_DESC = theList[i].ACIR_NgResult.NgCode;
                                BatInfo.REV_OCV = theList[i].Rev_OCV;
