...
namespace OCV
{
    ...
    public class ET_CELL
    {
        ...
        public double OCV_ShellPostive_Now;
        ...
        /// 压降判断结果
        /// </summary>
        public NgResult VoltDrop_NowState { get; set; }
        ...
        public NgResult PostiveSV_NgResult;
    ...
    public struct SaveDataCsv
    {
        ...
        public string PostiveOCV_Shell_Now;
        ...
        public string VoltDrop_NgResult;
