        ...
        private static int GetProjectInfo_Loc(int ProjectSetType, int OCVtype, string BattType)
        {
            ...
            try
            {
                ...
                else if (ClsGlobal.TestType == 1)
                {
                    ...
                    ClsGlobal.UpLmt_SVP = double.Parse(INIAPI.INIGetStringValue(mProjectPath, mConfig, "UpLmt_SVP", null));
                    ClsGlobal.DownLmt_SVP = double.Parse(INIAPI.INIGetStringValue(mProjectPath, mConfig, "DownLmt_SVP", null));
                }
