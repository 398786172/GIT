...
namespace OCV
{
    ...
    {
        //串口参数
        private SerialPort SPort = null;                                //对应串口 
        ...
        public void ChannelVoltSwitch(int POSConnType, int Channel)
        {
            try
            {
                ...
                {
                    case 1:
                        this.ChanndlVoltSwitchContr(Channel);
                        break;
                    case 2:
        ...
        /// 切换测量电压
        /// </summary>
        /// <param name="POSConnType">正极连接类型:  正极对负极->1, 壳体对负极->2，壳体对正接->3</param>
        /// <param name="Channel">通道号</param>
