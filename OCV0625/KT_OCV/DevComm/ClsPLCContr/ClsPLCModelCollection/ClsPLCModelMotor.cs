...
namespace OCV.DevComm.ClsPLCContr.ClsPLCModelCollection
{
   public class ClsPLCModelMotor
    { //交互信号
        public short Plc_AutoManual { set; get; }       //手自动模式
        ...
        public short Plc_InitReply { get; set; }
