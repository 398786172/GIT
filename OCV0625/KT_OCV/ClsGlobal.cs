...
namespace OCV
{
    ...
    public class ClsGlobal
    {
        ...
        public static DBCOM_OCV mDBCOM_OCV_BYD;     //OCV数据库接口  擎天服务器
        ...
        public static SqLiteHelper sqlCodeData = null;            //sqlLite
        public static SqLiteHelper sql_logDB;
        ...
        public static bool IsRetest = false;
        ...
        public static int OCVTypeShow;                      //OCV1: 充放电后OCV , OCV2:老化后OCV, OCV3:分选前OCV

        public static int IsLocalOCVType;              //是否是本地类型

        public static bool IsAutoMode = true;              //是否是本地类型

        public static int ExpEnable;  //

        public static int Time_t;

        public static int ChannelExp_n;

        public static int TrayExp_m;
        ...
        public static int BatTypeLen;


        public static int BatClassLen;

        public static double OCV23BCValue;

        public static DateTime OCV3BCTime = DateTime.MaxValue;

        public static bool IsTestAgain = false;
        ...
        public static int UIsettingTestType;
        ...
        public static List<RetestData> RetestList = new List<RetestData>();
        ...
        /// 写日志
        /// </summary>
        /// <param name="sInfo">log信息</param>
        /// <param name="Logspath">log路径</param>
        public static void WriteLog(string sInfo, string Logspath)
        {
            ...
            try
            {
                ...
                {
                    sw.WriteLine(DateTime.Now + ": " + sInfo);
        ...
        /// <param name="sInfo">log信息</param>
        /// <param name="Logspath">log路径</param>
        public static void WriteDebugLog(string sInfo, string Logspath)
        {
            //日志
            try
            {
                using (StreamWriter sw = new StreamWriter(Logspath, false))
                {
                    sw.WriteLine(DateTime.Now + ": " + sInfo);
        ...
        /// <returns></returns>
        private static bool IsInUse(string fileName)
        {
        ...
        public static int SleepTime = 150;               //切换通道时间   单位毫秒
        ...
        //壳压/正极NG设定
        public static double UpLmt_SVP;
        public static double DownLmt_SVP;
        ...
        public static bool mAlarmFlag = false;
