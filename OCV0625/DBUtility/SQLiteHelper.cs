...
namespace DBUtility
{
    ...
    public class SQLiteHelper
    {
        ...
        public string DataSource
        {
            ...
            set
            {
                SQLiteHelp.sqliteFileLockers.TryAdd(value, new object());
                mDataSource = value;
            }
        }
        ...
        public static bool CheckFieldExist(string connectionString, string tableName, string fieldName, string formatStr, object defaultVal = null)
        {
            bool flag = false;
            ...
            if (flag == false)
            {
                sql = "ALTER TABLE '" + tableName + "' ADD '" + fieldName + "' " + formatStr;

                if (defaultVal != null)
                {
                    sql += " DEFAULT " + defaultVal.ToString();
                }
        ...
        public static bool ExeNonQueryUseTrans(string connectionString, CommandType commandType, List<string> commandText)
        {
            SQLiteConnection mConn = new SQLiteConnection(connectionString);
        ...
        /// <param name="commandText">SQL语句数组</param>
        /// <returns>True：SQL语句正常执行完成，False：SQL语句执行过程中出错</returns>
        public static bool ExeNonQueryUseTrans(SQLiteConnection mConn, CommandType commandType, List<string> commandText)
        {
            try
            {
                if (mConn.State != ConnectionState.Open)
